...
export const ResourceIcon = ({ size = 15 }: IconProps) => (
  <svg {...base(size)}>
    <path d="M5.5 4.5h9l4 4v11h-13z" />
    <path d="M14 4.5v4.5h4.5M8.5 13h7M8.5 16.5h4.5" />
  </svg>
);
...
/** A display, for "follow whatever the system is doing". */
export const SystemThemeIcon = ({ size = 14 }: IconProps) => (
  <svg {...base(size)}>
